...
def main():
    config = {
        ...
        'load_model_path': '/home/lawson/program/daguan/risk_data_grand/model/2.4G+4.8M_large_10000_128_40000_checkpoint-50000_epoch_10_90', # 加载训练后的模型
        'submit_path': 'submission_90.csv', # 提交结果的文件名
        'batch_size': 8,
        'max_seq_len': 100, 
        'device': 'cuda',
    }
